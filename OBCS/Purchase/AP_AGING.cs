...
{
    public partial class AP_AGING : Form
    {
        public AP_AGING()
        {
            InitializeComponent();
        ...
        private void grid_aging_Init()
        {
            ...
            grid_aging.Columns[0].Name = "Supplier ID";
            grid_aging.Columns[0].ReadOnly = true;
            grid_aging.Columns[0].Width = 150;
            grid_aging.Columns[0].MinimumWidth = 150;
            ...
            grid_aging.Columns[0].DataPropertyName = "SupplierID";

            grid_aging.Columns[1].Name = "Supplier Name";
            ...
            grid_aging.Columns[1].DataPropertyName = "SupplierName";
            ...
            grid_aging.Columns[3].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            grid_aging.Columns[6].Name = "+ 90 Days";
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            ...
            connSalesOrder.sp_AGING_AP_SUMMARY(grid_aging, date, CustomerID);
        }
        ...
        private void grid_aging_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            ...
            //DataTable dataTable = (DataTable)grid_aging.DataSource;
            //DataRow drToAdd = dataTable.NewRow();
            //drToAdd["CustomerID"] = "TOTAL";
            //drToAdd["NotDue"] = TotalnotDue.ToString();
            //drToAdd["Days030"] = Total030.ToString();
            //drToAdd["Days3160"] = Total3160.ToString();
            //drToAdd["Days6190"] = Total6190.ToString();
            //drToAdd["Days90Over"] = Total91.ToString();
            //drToAdd["Total"] = TotalOpenAR.ToString();
        ...
        private void btn_export_Click(object sender, EventArgs e)
        {
            ...
            string CustomerID = txt_CustomerID.Text.Trim();
            Reports.Rpt_AGING_AP_SUMMARY AP_SUMMARY = new Reports.Rpt_AGING_AP_SUMMARY(Todate, CustomerID);
            AP_SUMMARY.Show();
            Reports.Rpt_AGING_AP_DETAIL AP_DETAIL = new Reports.Rpt_AGING_AP_DETAIL(Todate, CustomerID);
            AP_DETAIL.Show();
        }
    }
}
