...
namespace OBCS.Account
{
    ...
    {
        private string st_account = "", st_description = "";
        ...
        private void grid_header_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            String Description = grid_header.Rows[e.RowIndex].Cells["Description"].Value.ToString().Trim();
            st_account = Account;
            ...
            connSalesOrder.sp_ACCOUNT_CHARTOFACCOUNT_DETAIL(grid_detail, CompanyName, Account, FromDateString, ToDateString);
        }
        ...
        private void btn_exportHeader_Click(object sender, EventArgs e)
        {
            String CompanyName = cbo_company.Text.Trim();
            DateTime FromDate = dateTimePicker1.Value.Date;
            DateTime ToDate = dateTimePicker2.Value.Date;
            
            Reports.Rpt_ChartOfAccount_Header chart_Of_Account_header = new Reports.Rpt_ChartOfAccount_Header(CompanyName, FromDate, ToDate);
            chart_Of_Account_header.Show();
        }
        ...
        private void btn_export_Click(object sender, EventArgs e)
        {
            ...
            DateTime FromDate = dateTimePicker1.Value.Date;
            DateTime ToDate = dateTimePicker2.Value.Date;
            Reports.Rpt_Chart_Of_Account chart_Of_Account = new Reports.Rpt_Chart_Of_Account(CompanyName, st_account, st_description, FromDate, ToDate);
            //salesReport.MdiParent = this.MdiParent;
            chart_Of_Account.Show();
        }
    }
}
