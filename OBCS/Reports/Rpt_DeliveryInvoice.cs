...
{
    public partial class Rpt_DeliveryInvoice : Form
    {
        public Rpt_DeliveryInvoice(String OrderID)
        {
            InitializeComponent();
            ...
            this.Rpt_Fetch_DeliveryInvoiceTableAdapter.Fill(this.DeliveryInvoice2.Rpt_Fetch_DeliveryInvoice, OrderID);
            ...
            ps.Margins = new Margins(20,20, 25 , 25); //Set margins
        ...
        private void Rpt_DeliveryInvoice_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'DeliveryInvoice2.Rpt_Fetch_DeliveryInvoice' table. You can move, or remove it, as needed.
            //this.Rpt_Fetch_DeliveryInvoiceTableAdapter.Fill(this.DeliveryInvoice2.Rpt_Fetch_DeliveryInvoice);
