...
{
    public partial class Rpt_SalesbyCustomerDetailReport : Form
    {
        public Rpt_SalesbyCustomerDetailReport(DateTime FROMDATE, DateTime TODATE, String CustomerID, String CustomerName, String REP, String City, String State, String InvoiceNumber,bool CityAll, bool StateAll)
        {
            InitializeComponent();
        ...
        private void Rpt_SalesbyCustomerDetailReport_Load(object sender, EventArgs e)
        {
