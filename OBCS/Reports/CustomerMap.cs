...
namespace OBCS.Reports
{
    public partial class CustomerMap : Form 
    {
        ...
        private void grid_Customer_Init()
        {
            ...
            /*
            grid_Customer.Columns[23].Name = "Net Sales";
            grid_Customer.Columns[23].ReadOnly = true;
            grid_Customer.Columns[23].Width = 50;
            grid_Customer.Columns[23].MinimumWidth = 50;
            grid_Customer.Columns[23].Visible = false;
            grid_Customer.Columns[23].DefaultCellStyle.Format = "N2";
            grid_Customer.Columns[23].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            grid_Customer.Columns[23].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            grid_Customer.Columns[23].DataPropertyName = "NetSales";
            */
        ...
        private void btn_Search_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    if (grid_SalesRep.Rows[i].Cells[0].Value.Equals(true)) selectedItem += 1;
            //}
            //MessageBox.Show("You can select up to 9.", "Color Maximum", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
