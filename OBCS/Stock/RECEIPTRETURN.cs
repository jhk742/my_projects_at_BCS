...
{
    public partial class RECEIPTRETURN : Form
    {
        public RECEIPTRETURN()
        {
            ...
            connSalesOrder.sp_RECEIPTRETURN_HEADER(grid_header, FromDate, ToDate);
            connSalesOrder.sp_RECEIPTRETURN_DETAIL(grid_Basket, "GRID_BASKET_INITIALIZE");
        ...
        private void grid_header_Init()
        {
            ...
            grid_header.Columns[0].Width = 35;
            ...
            grid_header.Columns[1].Width = 35;
            ...
            grid_header.Columns[2].Width = 75;
            ...
            grid_header.Columns[3].DataPropertyName = "BPRNUM_0";
            ...
            grid_header.Columns[5].Width = 120;
            ...
            grid_header.Columns[5].DataPropertyName = "VCRNUMREG_0";

            grid_header.Columns[6].Name = "Transaction Date";
            grid_header.Columns[6].ReadOnly = true;
            grid_header.Columns[6].Width = 60;
            ...
            grid_header.Columns[6].DataPropertyName = "CREDAT_0";

            grid_header.Columns[7].Name = "User";
            grid_header.Columns[7].ReadOnly = true;
            grid_header.Columns[7].Width = 50;
            ...
            grid_header.Columns[7].DataPropertyName = "CREUSR_0";
        ...
        private void grid_Detail_Init()
        {
            ...
            grid_detail.Columns[2].Width = 115;
        ...
        private void grid_stock_Init()
        {
            ...
            grid_stock.Columns[4].Width = 35;
            grid_stock.Columns[4].MinimumWidth = 35;
            ...
            grid_stock.Columns[15].Name = "Transaction change";
            grid_stock.Columns[15].ReadOnly = true;
            grid_stock.Columns[15].Width = 140;
            ...
            grid_stock.Columns[15].DataPropertyName = "TRANSACTION_CHANGE";
        ...
        private void LotInformationByProductID()
        {
            try
            {
                ...
                connSalesOrder.sp_RECEIPTRETURN_SELECT_LOT(grid_stock, Company, StorageSite, ItemID);
        ...
        private void Initialized()
        {
            ...
            connSalesOrder.sp_RECEIPTRETURN_HEADER(grid_header, dateTimePickerFrom.Value.Date, dateTimePickerTo.Value.Date);
        }
        ...
        private void cbo_supplierID_SelectedValueChanged(object sender, EventArgs e)
        {
            try
            {
                String SupplierCode = cbo_supplierID.Text.ToString();
                Entities.SupplierObject Supplier = new Entities.SupplierObject();

                Supplier = connSalesOrder.sp_GET_SupplierObject(SupplierCode);

                txt_SupplierName.Text = Supplier.SupplierName;
                txt_Category.Text = Supplier.SupplierCategory;
                txt_PaymentTerm.Text = Supplier.PaymentTerm;
                txt_ShipVia.Text = Supplier.ShipVia;
            }
            catch (Exception ex)
            {
        ...
        {
            String ReturnNumber = grid_header.Rows[e.RowIndex].Cells["Number"].Value.ToString();
            connSalesOrder.sp_RECEIPTRETURN_DETAIL(grid_detail, ReturnNumber);
        }
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DialogResult dialogResult = MessageBox.Show("Are you sure to continue Receipt return process?"
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    if (!NewBCSPRNNumber.Contains("BCSPRN"))
                    {
                        MessageBox.Show("Please try again.(BCSPRN) (Error code: " + NewBCSPRNNumber + ")"
                                                        , "Stop", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        return;
                    }
                    ...
                    for (int i = 0; i < grid_Basket.RowCount; i++)
                    {
                        ...
                        String SaveDetailResult = connSalesOrder.sp_RECEIPTRETURN_INSERT_STOJOU(NewBCSPRNNumber, NewSTKNumber, CompanyCode, StorageSite,
                            SupplierID, LotNumber, SelectedProductID, OrderQtys, i, Memo);
