...
namespace OBCS.Stock
{
    public partial class Assembly : Form
    {
        public Assembly()
        {
            ...
            connSalesOrder.sp_ASSEMBLY_SELECT(grid_header, FromDate, ToDate);
        ...
        private void Initialized()
        {
            ...
            connSalesOrder.sp_ASSEMBLY_SELECT(grid_header, dateTimePickerFrom.Value.Date, dateTimePickerTo.Value.Date);
        }
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DialogResult dialogResult = MessageBox.Show("Are you sure to continue Assembly process?"
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    String NewASMNumber = connSalesOrder.sp_GET_NewASMNumber();
                    String SaveHeaderResult = connSalesOrder.sp_ASSEMBLY_SAVE_HEADER(NewASMNumber, AccountingDate, Memo, Company, Site);
                    ...
                    for (int i = 0; i < grid_Basket.RowCount; i++)
                    {
                        ...
                        String SaveDetailResult = connSalesOrder.sp_ASSEMBLY_SAVE(NewASMNumber, StorageSite, SelectedProductID, LotNumber, Status, Expiration, OrderQtys, Amount, i + 1);
